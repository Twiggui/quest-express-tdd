...
describe('Test routes', () => {
  ...
  it('POST /bookmarks send empty object return 422 code', (done) => {
    request(app)
      .post('/bookmarks')
      .send({})
      .expect(422)
  ...
  it('POST /bookmarks send object send back object', (done) => {
    request(app)
      .post('/bookmarks')
  ...
  describe('GET /bookmarks/:id', () => {
    ...
    it("GET /bookmark/:id id doesn't exist send back error", (done) => {
      request(app)
        .get('/bookmarks/2')
        .expect(404)
        .expect('Content-Type', /json/)
    ...
    it('GET /bookmark/:id send back an object as json', (done) => {
      request(app)
        .get('/bookmarks/1')
        .expect(200)
        .expect('Content-Type', /json/)
